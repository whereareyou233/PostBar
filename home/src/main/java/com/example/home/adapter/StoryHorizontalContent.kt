...
class StoryHorizontalContent (val context: Context, val List :List<StoryInfo>):
    RecyclerView.Adapter<StoryHorizontalContent.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view= LayoutInflater.from(parent.context).inflate(R.layout.item_story_horizontal,parent,false)
